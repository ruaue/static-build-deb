...
cargo build  --target x86_64-unknown-linux-musl --bin ssserver --release --no-default-features --features="server aead-cipher aead-cipher-extra aead-cipher-2022 aead-cipher-2022-extra multi-threaded"
