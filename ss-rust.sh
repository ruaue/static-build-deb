...
cargo build --target x86_64-unknown-linux-musl --bin ssserver --release --no-default-features --features="server stream-cipher aead-cipher-2022 mimalloc multi-threaded"
